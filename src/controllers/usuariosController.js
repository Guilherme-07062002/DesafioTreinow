...
// Conforme pedido foi utilizado, o json web token para a autenticação
const jwt = require("jsonwebtoken");

const SECRET = 'secret'
// A blacklist serve para que um usuário que fez logout não possa acessar o site, antes que ele faça login novamente
const blacklist = []
